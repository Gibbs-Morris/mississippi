...
description: 'Internal final verification subagent for verification-first enterprise development. Use when: applying Chain-of-Verification to confirm final changes satisfy the task, tests prove behavior, C4 matches implementation, reviews are resolved, and handoff is resumable.'
model:
  - 'GPT-5.4 (copilot)'
  - 'GPT-5 (copilot)'
...
- Current review findings and resolution status.
...
- C4 diagrams contradict implementation.
