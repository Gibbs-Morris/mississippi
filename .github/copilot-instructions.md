...
- When a resolved problem reveals a failure mode or process gap that can recur across tasks, Copilot **MUST** follow [self-improvement learning](instructions/self-improvement.instructions.md) and record the validated lesson. Why: Reusable learning should reach future Copilot and Codex tasks.
