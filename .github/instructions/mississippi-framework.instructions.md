...
- Spring samples **SHOULD** use `AddSpringDomain` registration wrappers in client/server/silo projects to aggregate generated registrations and keep Program.cs minimal. Why: Reduces manual lists while preserving generator-driven wiring.
