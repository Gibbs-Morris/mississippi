...
- New/refactored APIs **MUST** align with primary .NET behaviors/patterns; if ambiguous, use widely adopted .NET conventions; Orleans-grain APIs **MUST** match Orleans developer expectations. Why: Minimizes context switching and improves DX.
