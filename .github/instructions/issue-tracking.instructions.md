...
- For pre-existing changes or unattended producers that could not create issues before generation, maintainers **MUST** complete retrospective intake during triage before further implementation or review approval. This timing exception does not waive issue content, updates, disclosure, or PR links. Why: Generated work still needs a documented plan before acceptance.
