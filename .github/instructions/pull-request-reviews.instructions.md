...
- [C# General Development Best Practices](./csharp.instructions.md)
- [Testing Strategy and Quality Gates](./testing.instructions.md)
- [Mutation Testing Playbook](./mutation-testing.instructions.md)
- [Service Registration and Configuration](./service-registration.instructions.md)
- [Enterprise Logging Best Practices](./logging-rules.instructions.md)
- [Instruction Authoring Guide](./authoring.instructions.md)
