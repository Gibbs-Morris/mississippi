...
- **Cleanup Samples**: `pwsh ./scripts/clean-up-sample-solution.ps1`
- **Unit tests (Mississippi)**: `pwsh ./scripts/unit-test-mississippi-solution.ps1`
- **Unit tests (Samples)**: `pwsh ./scripts/unit-test-sample-solution.ps1`
- **Mutation tests (Mississippi)**: `pwsh ./scripts/mutation-test-mississippi-solution.ps1`
- **Per-project test quality**: `pwsh ./scripts/test-project-quality.ps1 -TestProject <Name> [-SkipMutation]`
