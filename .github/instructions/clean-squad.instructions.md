...
- `cs Entrepreneur` **MUST NOT** create governed workflow state, `.thinking/<task>/workflow-audit.json`, or any canonical audit fact. Why: The optional pre-governed lane shapes ideas but never starts governed delivery.
