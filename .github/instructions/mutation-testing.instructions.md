...
4. **Collect & prioritize survivors** – Open the newest `StrykerOutput/**/reports/mutation-report.json` only if deep inspection is needed. Otherwise run the summarizer:
