...
- Agents MUST follow [issue tracking and PR traceability](.github/instructions/issue-tracking.instructions.md): record the plan in a repository issue before implementation, keep it current, and link every PR to an issue. Why: Requested work needs a durable record through delivery.
