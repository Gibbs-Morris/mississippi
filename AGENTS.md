...
- Agents MUST reassess instruction selection when the task expands and follow relevant policy references and explicit skill routes. Why: Initial context selection is not a permanent permission to omit later requirements.
