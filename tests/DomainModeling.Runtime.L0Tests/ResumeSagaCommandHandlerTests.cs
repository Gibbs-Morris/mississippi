...
public sealed class ResumeSagaCommandHandlerTests
{
    ...
    )
    {
        ...
        ResumeSagaCommand command = missingField switch
        {
            ...
            var _ => throw new InvalidOperationException($"Unknown missing field '{missingField}'."),
        };
    ...
    public void HandleGeneratesOperationIdentityWhenMissing()
    {
        ...
        Assert.Equal(
            SagaStepOperationKey.Compute(sagaId, 2, SagaExecutionDirection.Compensation),
            started.OperationKey);
