...
public sealed class IRipplePoolTests
{
    ...
    {
        // Arrange & Act
        Type type = typeof(IRipplePool<object>);
        MethodInfo? method = type.GetMethod(nameof(IRipplePool<object>.GetOrCreate));
    ...
    public void MarkHiddenMethodIsDefined()
    {
        // Arrange & Act
        Type type = typeof(IRipplePool<object>);
        MethodInfo? method = type.GetMethod(nameof(IRipplePool<object>.MarkHidden));
    ...
    public void MarkVisibleMethodIsDefined()
    {
        // Arrange & Act
        Type type = typeof(IRipplePool<object>);
        MethodInfo? method = type.GetMethod(nameof(IRipplePool<object>.MarkVisible));
    ...
    public void PrefetchAsyncMethodIsDefined()
    {
        // Arrange & Act
        Type type = typeof(IRipplePool<object>);
        MethodInfo? method = type.GetMethod(nameof(IRipplePool<object>.PrefetchAsync));
    ...
    public void StatsPropertyIsDefined()
    {
        // Arrange & Act
        Type type = typeof(IRipplePool<object>);
        PropertyInfo? property = type.GetProperty(nameof(IRipplePool<object>.Stats));
