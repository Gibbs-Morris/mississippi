...
public class CommandClientDtoGeneratorTests
{
    ...
    /// </summary>
    [Fact]
    public void GeneratedDtoHasPropertiesFromCommand()
    {
        const string commandSource = """
                                     using Mississippi.Inlet.Generators.Abstractions;
    ...
    /// <summary>
    ///     Multiple commands should generate separate DTOs.
    /// </summary>
    [Fact]
    public void MultipleCommandsGenerateSeparateDtos()
    {
        const string commandSource = """
                                     using Mississippi.Inlet.Generators.Abstractions;
        ...
        bool hasPlaceOrderDto = runResult.GeneratedTrees.Any(t => t.FilePath.Contains(
            "PlaceOrderRequestDto",
            StringComparison.Ordinal));
        bool hasCancelOrderDto = runResult.GeneratedTrees.Any(t => t.FilePath.Contains(
