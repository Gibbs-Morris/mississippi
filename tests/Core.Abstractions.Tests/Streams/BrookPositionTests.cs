...
namespace Mississippi.Core.Abstractions.Tests.Streams
{
    public class BrookPositionTests
    {
        ...
        public void Constructor_WithNonNegativeValue_SetsValue(long input)
        {
            var position = new BrookPosition(input);
        ...
        {
            var earlier = new BrookPosition(5);
            var later = new BrookPosition(10);
        ...
        {
            var a = new BrookPosition(5);
            var b = new BrookPosition(5);
