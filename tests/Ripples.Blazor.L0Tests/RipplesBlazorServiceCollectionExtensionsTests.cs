...
public sealed class RipplesBlazorServiceCollectionExtensionsTests
{
    ...
    public void AddRippleRegistersFactory()
    {
        ...
        services.Should().ContainSingle(d =>
            d.ServiceType == typeof(IRipple<TestProjection>));
    }
    ...
    public void AddRipplePoolRegistersFactory()
    {
        ...
        // Assert
        services.Should().ContainSingle(d =>
            d.ServiceType == typeof(IRipplePool<TestProjection>));
    }
    ...
    [System.Diagnostics.CodeAnalysis.SuppressMessage("SonarQube", "S2094:Classes should not be empty", Justification = "Test stub class.")]
