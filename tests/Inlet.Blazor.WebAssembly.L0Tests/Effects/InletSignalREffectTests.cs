...
public sealed class InletSignalREffectTests : IAsyncDisposable
{
    ...
    public InletSignalREffectTests()
    {
        ...
        navManagerMock.Setup(n => n.ToAbsoluteUri(It.IsAny<string>()))
            .Returns<string>(path => new Uri($"http://localhost{path}"));
        ...
        // Create effect
        InletSignalREffectOptions options = new() { HubPath = TestHubPath };
    ...
    public void ConstructorThrowsWhenServiceProviderIsNull()
    {
        ...
        Assert.Throws<ArgumentNullException>(() =>
            new InletSignalREffect(null!, navManagerMock.Object, fetcherMock.Object, registry));
    }
    ...
    public void ConstructorThrowsWhenNavigationManagerIsNull()
    {
        ...
        // Act & Assert
        Assert.Throws<ArgumentNullException>(() =>
            new InletSignalREffect(provider, null!, fetcherMock.Object, registry));
    }
    ...
    public void ConstructorThrowsWhenProjectionFetcherIsNull()
    {
        ...
        // Act & Assert
        Assert.Throws<ArgumentNullException>(() =>
            new InletSignalREffect(provider, navManagerMock.Object, null!, registry));
    }
    ...
    public void ConstructorThrowsWhenProjectionDtoRegistryIsNull()
    {
        ...
        // Act & Assert
        Assert.Throws<ArgumentNullException>(() =>
            new InletSignalREffect(provider, navManagerMock.Object, fetcherMock.Object, null!));
    }
