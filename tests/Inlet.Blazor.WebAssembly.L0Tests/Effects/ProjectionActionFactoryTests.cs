...
public sealed class ProjectionActionFactoryTests
{
    ...
    {
        // Arrange / Act / Assert
        Assert.Throws<ArgumentNullException>(() => ProjectionActionFactory.CreateError(
    ...
    {
        // Arrange / Act / Assert
        Assert.Throws<ArgumentNullException>(() => ProjectionActionFactory.CreateLoading(null!, "entity-123"));
    }
