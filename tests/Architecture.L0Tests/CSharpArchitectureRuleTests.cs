...
public sealed class CSharpArchitectureRuleTests
{
    ...
    public void ConstructorInjectedFieldFixtureIsRejectedButPropertyAndStateAreAccepted()
    {
        ...
        _ = new HelperAssignmentFixture(clock).GetClock();
        ...
        _ = new StaticInjectedFieldFixture(clock).GetClock();
        ...
        [
            ...
            typeof(StaticInjectedFieldFixture),
        ...
        Assert.Contains($"{typeof(StaticInjectedFieldFixture).FullName}.clock", violations);
