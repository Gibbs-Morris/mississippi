...
public sealed class AbstractionsLayeringTests : ArchitectureTestBase
{
    ...
    public void AbstractBaseClassesInAbstractionsShouldEndWithBase()
    {
        ...
        IArchRule rule = Classes()
            ...
            .Because(
                "abstract base classes in abstractions MUST end with Base per abstractions-projects.instructions.md")
    ...
    public void AbstractionsNamespacesShouldFollowNamingConvention()
    {
        ...
        IArchRule rule = Types()
            ...
            .ResideInNamespaceMatching(
                @"^Mississippi\.[A-Z][a-zA-Z0-9]+(\.[A-Z][a-zA-Z0-9]+)*\.Abstractions(\.[A-Z][a-zA-Z0-9]+)*$")
            .Because(
                "abstractions namespace naming SHOULD follow {Vendor}.{Area}[.{Feature}].Abstractions per abstractions-projects.instructions.md");
        rule.Check(ArchitectureModel);
    }
    ...
    public void AbstractionsShouldNotContainInfrastructureTypes()
    {
        ...
        IArchRule rule = Classes()
            ...
            .Because(
                "abstractions MUST NOT contain infrastructure/DI/persistence/hosting code per abstractions-projects.instructions.md");
        rule.Check(ArchitectureModel);
    }
