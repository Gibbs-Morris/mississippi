...
public sealed class ProjectionActionsTests
{
    ...
    public void ProjectionLoadedActionConstructorSetsEntityId()
    {
        ...
        TestProjection data = new() { Name = "Test" };
    ...
    {
        // Arrange
        TestProjection data = new() { Name = "Test Data" };
    ...
    public void ProjectionLoadedActionConstructorSetsVersion()
    {
        ...
        // Act
        ProjectionLoadedAction<TestProjection> action = new("entity-123", new TestProjection(), version);
    ...
    public void ProjectionUpdatedActionConstructorSetsEntityId()
    {
        ...
        // Act
        ProjectionUpdatedAction<TestProjection> action = new(entityId, new TestProjection(), 2);
    ...
    {
        // Arrange
        TestProjection data = new() { Name = "Updated Data" };
    ...
    public void ProjectionUpdatedActionConstructorSetsVersion()
    {
        ...
        // Act
        ProjectionUpdatedAction<TestProjection> action = new("entity-123", new TestProjection(), version);
