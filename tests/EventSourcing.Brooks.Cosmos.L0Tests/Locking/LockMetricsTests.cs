...
public sealed class LockMetricsTests
{
    ...
    public void RecordAcquireFailureEmitsFailureCount()
    {
        ...
        // Assert
        MetricMeasurement? failureMeasurement = measurements.Find(m =>
            m.InstrumentName == "lock.acquire.failures");
    ...
    public void RecordAcquireFailureEmitsDuration()
    {
        ...
        MetricMeasurement? durationMeasurement = measurements.Find(m =>
            m.InstrumentName == "lock.acquire.duration");
    ...
    public void RecordAcquireSuccessEmitsRetryAttempts()
    {
        ...
        // Assert
        MetricMeasurement? attemptsMeasurement = measurements.Find(m =>
            m.InstrumentName == "lock.acquire.attempts");
    ...
    public void RecordContentionWaitEmitsCount()
    {
        ...
        // Assert
        MetricMeasurement? contentionMeasurement = measurements.Find(m =>
            m.InstrumentName == "lock.contention.waits");
    ...
    public void RecordHeldDurationEmitsDuration()
    {
        ...
        // Assert
        MetricMeasurement? heldMeasurement = measurements.Find(m =>
            m.InstrumentName == "lock.held.duration");
