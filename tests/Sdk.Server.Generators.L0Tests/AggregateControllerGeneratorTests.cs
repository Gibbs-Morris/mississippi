...
using Mississippi.Sdk.Server.Generators;


namespace Mississippi.Sdk.Server.Generators.L0Tests;
...
public class AggregateControllerGeneratorTests
{
    ...
    public void GeneratorProducesNoOutputWhenNoAggregates()
    {
        ...
        (_, _, GeneratorDriverRunResult runResult) = RunGenerator(AttributeStubs, source);
    ...
    public void GeneratorProducesNoOutputWhenAggregateHasNoCommands()
    {
        ...
        (_, _, GeneratorDriverRunResult runResult) = RunGenerator(AttributeStubs, aggregateSource);
    ...
    public void GeneratedControllerIncludesMapperForEachCommand()
    {
        ...
        Assert.Contains("IMapper<CreateOrderDto, CreateOrder> createOrderMapper", generatedCode, StringComparison.Ordinal);
        Assert.Contains("IMapper<CancelOrderDto, CancelOrder> cancelOrderMapper", generatedCode, StringComparison.Ordinal);
    }
    ...
    public void GeneratedControllerIncludesActionMethodForEachCommand()
    {
        ...
        Assert.Contains("public Task<ActionResult<OperationResult>> CreateOrderAsync(", generatedCode, StringComparison.Ordinal);
        Assert.Contains("public Task<ActionResult<OperationResult>> CancelOrderAsync(", generatedCode, StringComparison.Ordinal);
    }
    ...
    public void GeneratedControllerIncludesExecuteCommandAsyncMethod()
    {
        ...
        Assert.Contains("private Task<OperationResult> ExecuteCommandAsync<TCommand>(", generatedCode, StringComparison.Ordinal);
        Assert.Contains("AggregateGrainFactory.GetGenericAggregate<OrderAggregate>(entityId)", generatedCode, StringComparison.Ordinal);
    ...
    public void GeneratedControllerIncludesRequiredUsingStatements()
    {
        ...
        Assert.Contains("using Mississippi.EventSourcing.Aggregates.Abstractions;", generatedCode, StringComparison.Ordinal);
    ...
    public void GeneratedControllerIncludesGeneratedCodeAttribute()
    {
        ...
        Assert.Contains("[global::System.CodeDom.Compiler.GeneratedCode(\"AggregateControllerGenerator\"", generatedCode, StringComparison.Ordinal);
    }
    ...
    public void ActionMethodIncludesParameterDocumentation()
    {
        ...
        Assert.Contains("/// <param name=\"entityId\">The entity identifier.</param>", generatedCode, StringComparison.Ordinal);
        Assert.Contains("/// <param name=\"request\">The command request.</param>", generatedCode, StringComparison.Ordinal);
        Assert.Contains("/// <param name=\"cancellationToken\">Cancellation token.</param>", generatedCode, StringComparison.Ordinal);
    ...
    public void GeneratorHandlesMultipleAggregates()
    {
        ...
        List<string> generatedFileNames = runResult.Results[0]
            .GeneratedSources
            .Select(s => s.HintName)
            .ToList();
