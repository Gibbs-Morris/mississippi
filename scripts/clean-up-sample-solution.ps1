...
try {
    Write-Host "=== SAMPLE SOLUTION CODE CLEANUP PROCESS ===" -ForegroundColor Yellow
    ...
    Write-Host ""
    Write-Host "=== SAMPLE SOLUTION CLEANUP COMPLETED ===" -ForegroundColor Green
    Write-Host "All sample code files have been formatted according to project standards"
} catch {
