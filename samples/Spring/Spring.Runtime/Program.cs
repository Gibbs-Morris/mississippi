...
builder.UseOrleans(siloBuilder =>
{
    ...
    {
        // Register all Spring domain aggregates, projections, and sagas
        ...
        // Cosmos storage for Brooks (event streams)
        ...
        // Aqueduct for SignalR backplane via stream provider
        runtime.AddAqueduct(options => options.StreamProviderName = "StreamProvider");

        // Inlet runtime for projection subscription management
