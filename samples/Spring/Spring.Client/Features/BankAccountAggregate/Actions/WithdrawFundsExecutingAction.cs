...
internal sealed record WithdrawFundsExecutingAction(
    string CommandId,
    string CommandType,
...
{
    /// <inheritdoc />
    public static WithdrawFundsExecutingAction Create(string commandId, string commandType, DateTimeOffset timestamp)
