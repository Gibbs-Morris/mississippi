...
internal sealed record OpenAccountExecutingAction(
    string CommandId,
    string CommandType,
...
{
    /// <inheritdoc />
    public static OpenAccountExecutingAction Create(string commandId, string commandType, DateTimeOffset timestamp)
