...
internal static partial class TransferFundsSagaLoggerExtensions
{
    ...
    [LoggerMessage(Level = LogLevel.Information, Message = "Saga {SagaId}: Credited £{Amount} to account {AccountId}")]
    ...
    [LoggerMessage(Level = LogLevel.Information, Message = "Saga {SagaId}: Debited £{Amount} from account {AccountId}")]
    ...
    [LoggerMessage(Level = LogLevel.Information, Message = "Saga {SagaId}: Refunded £{Amount} to account {AccountId}")]
    ...
    [LoggerMessage(Level = LogLevel.Debug, Message = "Saga {SagaId}: Skipping compensation - {Reason}")]
