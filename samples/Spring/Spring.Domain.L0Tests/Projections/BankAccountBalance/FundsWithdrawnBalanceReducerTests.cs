...
[AllureSubSuite("BankAccountBalance - FundsWithdrawn")]
public sealed class FundsWithdrawnBalanceReducerTests
{
    ...
    public void ReduceWithFundsWithdrawnDecreasesBalance()
    {
        ...
        FundsWithdrawn evt = new() { Amount = 150.00m };
    ...
    public void ReduceWithFundsWithdrawnPreservesOtherProperties()
    {
        ...
        FundsWithdrawn evt = new() { Amount = 50.00m };
    ...
    public void ReduceWithMultipleWithdrawalsDecreasesBalanceCorrectly()
    {
        ...
        // Act
        state = reducer.Apply(state, new FundsWithdrawn { Amount = 100.00m });
        state = reducer.Apply(state, new FundsWithdrawn { Amount = 200.00m });
        state = reducer.Apply(state, new FundsWithdrawn { Amount = 50.00m });
    ...
    public void ReduceWithWithdrawalExceedingBalanceResultsInNegativeBalance()
    {
        ...
        FundsWithdrawn evt = new() { Amount = 100.00m };
