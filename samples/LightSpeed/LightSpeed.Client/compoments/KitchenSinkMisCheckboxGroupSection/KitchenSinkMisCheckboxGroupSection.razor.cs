...
public sealed partial class KitchenSinkMisCheckboxGroupSection : StoreComponent
{
    ...
    private IReadOnlyList<string> CheckboxGroupEvents =>
        Select<MisCheckboxGroupKitchenSinkState, IReadOnlyList<string>>(
            MisCheckboxGroupKitchenSinkSelectors.GetEventLog);

    private MisCheckboxGroupViewModel CheckboxGroupModel =>
        Select<MisCheckboxGroupKitchenSinkState, MisCheckboxGroupViewModel>(
            MisCheckboxGroupKitchenSinkSelectors.GetViewModel);
    ...
    private static string FormatAction(
        ...
        action switch
        {
            ...
            MisCheckboxGroupFocusedAction focused => $"intent={focused.IntentId}",
            MisCheckboxGroupBlurredAction blurred => $"intent={blurred.IntentId}",
