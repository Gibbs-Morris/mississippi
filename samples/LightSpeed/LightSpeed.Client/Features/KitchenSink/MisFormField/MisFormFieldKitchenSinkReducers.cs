...
internal static class MisFormFieldKitchenSinkReducers
{
    ...
    )
    {
        ...
        return state with
        {
            HelpText = action.HelpText ?? string.Empty,
        };
    }
    ...
    )
    {
        ...
        return state with
        {
            InputValue = action.InputValue ?? string.Empty,
        };
    }
    ...
    )
    {
        ...
        return state with
        {
            LabelText = action.LabelText ?? "Username",
        };
    }
    ...
    )
    {
        ...
        return state with
        {
            ValidationMessage = action.ValidationMessage ?? string.Empty,
        };
    }
}