...
/// <summary>
///     Unit tests for the <see cref="UserJoinedChannelProjectionEventReducer" /> class.
/// </summary>
[AllureParentSuite("Cascade")]
[AllureSuite("Core")]
[AllureSubSuite("Unit")]
public sealed class UserJoinedChannelProjectionEventReducerTests
{
    /// <summary>
    ...
    {
        // Arrange
        UserJoinedChannelProjectionEventReducer eventReducer = new();
