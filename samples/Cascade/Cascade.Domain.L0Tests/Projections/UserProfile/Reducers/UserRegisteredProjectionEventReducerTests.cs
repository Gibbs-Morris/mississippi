...
/// <summary>
///     Unit tests for the <see cref="UserRegisteredProjectionEventReducer" /> class.
/// </summary>
[AllureParentSuite("Cascade")]
[AllureSuite("Core")]
[AllureSubSuite("Unit")]
public sealed class UserRegisteredProjectionEventReducerTests
{
    /// <summary>
    ...
    {
        // Arrange
        UserRegisteredProjectionEventReducer eventReducer = new();
        ...
        // Act
        UserProfileProjection result = eventReducer.Reduce(null!, evt);
