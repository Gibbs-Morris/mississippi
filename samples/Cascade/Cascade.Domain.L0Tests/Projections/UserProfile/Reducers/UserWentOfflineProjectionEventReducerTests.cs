...
/// <summary>
///     Unit tests for the <see cref="UserWentOfflineProjectionEventReducer" /> class.
/// </summary>
[AllureParentSuite("Cascade")]
[AllureSuite("Core")]
[AllureSubSuite("Unit")]
public sealed class UserWentOfflineProjectionEventReducerTests
{
    /// <summary>
    ...
    {
        // Arrange
        UserWentOfflineProjectionEventReducer eventReducer = new();
