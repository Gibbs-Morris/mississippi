...
internal static partial class ConsoleAppLoggerExtensions
{
    ...
    public static partial void HostStarted(this ILogger logger, string runId);
    ...
    public static partial void ResolvingGrainFactory(this ILogger logger, string runId);
    ...
    [LoggerMessage(3, LogLevel.Information, "Run {RunId}: Cosmos options DatabaseId={DatabaseId}, ContainerId={ContainerId}, LockContainer={LockContainer}, MaxEventsPerBatch={MaxEventsPerBatch}, QueryBatchSize={QueryBatchSize}")]
    public static partial void CosmosOptions(this ILogger logger, string runId, string databaseId, string containerId, string lockContainer, int maxEventsPerBatch, int queryBatchSize);
    ...
    public static partial void UnableToResolveBrookStorageOptions(this ILogger logger, string runId, Exception ex);
    ...
    [LoggerMessage(5, LogLevel.Information, "Run {RunId}: Mode=reuse, Using persisted BrookKey={BrookKey} (state file: {Path})")]
    public static partial void ModeReuseUsingPersistedBrookKey(this ILogger logger, string runId, BrookKey brookKey, string path);
    ...
    /// <param name="path">The file path to the persisted state file.</param>
    [LoggerMessage(6, LogLevel.Information, "Run {RunId}: Mode=fresh, Using new BrookKey={BrookKey} (state file: {Path})")]
    public static partial void ModeFreshUsingNewBrookKey(this ILogger logger, string runId, BrookKey brookKey, string path);
    ...
    public static partial void ScenarioSmallBatch10x1KB(this ILogger logger);
    ...
    public static partial void ScenarioBulk100Mixed(this ILogger logger);
    ...
    public static partial void ScenarioLargeSingle200KB(this ILogger logger);
    ...
    public static partial void ScenarioLargeBatch200x5KB(this ILogger logger);
    ...
    public static partial void ScenarioOpsLimit100Mixed(this ILogger logger);
    ...
    public static partial void ReadbackAfterInitialAppends(this ILogger logger);
    ...
    public static partial void ScenarioInterleaved(this ILogger logger);
    ...
    public static partial void ScenarioMultiStream(this ILogger logger);
    ...
    public static partial void ExplicitCacheFlushReadback(this ILogger logger);
    ...
    public static partial void PerformingColdRestartOfHost(this ILogger logger, string runId);
    ...
    public static partial void ScenarioColdRestartReadback(this ILogger logger);
    ...
    public static partial void AppendingCounts(this ILogger logger, string runId, string scenario, int count, long bytes);
    ...
    public static partial void AppendComplete(this ILogger logger, string runId, string scenario, long cursor, int ms, double rateEvN, double rateMB);
    ...
    public static partial void AppendFailed(this ILogger logger, string runId, string scenario, int ms, int count, long bytes, Exception ex);
    ...
    public static partial void ReadbackCursor(this ILogger logger, string runId, long cursor);
    ...
    public static partial void NoEventsToRead(this ILogger logger, string runId);
    ...
    public static partial void ReadIdxEvent(this ILogger logger, string runId, int idx, string id, string type, int bytes);
    ...
    /// <param name="rateEvN">Event throughput in events/second.</param>
    /// <param name="rateMB">Data throughput in MB/second.</param>
    [LoggerMessage(43, LogLevel.Information, "Run {RunId}: Readback complete count={Count} bytes={Bytes} in {Ms} ms (throughput {RateEvN}/s, {RateMB}/s)")]
    public static partial void ReadbackComplete(this ILogger logger, string runId, int count, long bytes, int ms, double rateEvN, double rateMB);
    ...
    public static partial void ReadEnumerationAbortedRetry(this ILogger logger, string runId, Exception ex);
    ...
    public static partial void InterleaveStart(this ILogger logger, string runId);
    ...
    public static partial void CursorAfterWrite1(this ILogger logger, string runId, long cursor);
    ...
    public static partial void TailReadCount(this ILogger logger, string runId, int count);
    ...
    public static partial void CursorAfterWrite2(this ILogger logger, string runId, long cursor);
    ...
    public static partial void FullRangeReadCount(this ILogger logger, string runId, int count);
    ...
    public static partial void InterleaveEnumerationAbortedRetry(this ILogger logger, string runId, Exception ex);
    ...
    public static partial void CursorsAB(this ILogger logger, string runId, long cursorA, long cursorB);
    ...
    public static partial void StreamAEmpty(this ILogger logger, string runId);
    ...
    public static partial void StreamBEmpty(this ILogger logger, string runId);
    ...
    public static partial void ReadCountsAB(this ILogger logger, string runId, int countA, int countB);
    ...
    public static partial void RequestingDeactivations(this ILogger logger, string runId, BrookKey brookKey);
    ...
    public static partial void AggregateScenarioStart(this ILogger logger, string runId, string scenarioName, string counterId);
    ...
    public static partial void AggregateScenarioComplete(this ILogger logger, string runId, string scenarioName, string counterId, int ms);
    ...
    public static partial void AggregateCommandSuccess(this ILogger logger, string runId, string commandName);
    ...
    public static partial void AggregateCommandFailed(this ILogger logger, string runId, string commandName, string errorCode, string errorMessage);
    ...
    public static partial void AggregateScenarioNote(this ILogger logger, string runId, string note);
    ...
    public static partial void AggregateThroughputResult(this ILogger logger, string runId, int total, int success, int failed, int ms, double opsPerSec);
    ...
    public static partial void ScenarioAggregateBasicLifecycle(this ILogger logger);
    ...
    public static partial void ScenarioAggregateValidation(this ILogger logger);
    ...
    public static partial void ScenarioAggregateThroughput(this ILogger logger);
    ...
    public static partial void ScenarioAggregateConcurrency(this ILogger logger);
}
