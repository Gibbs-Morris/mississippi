...
/// <summary>
///     Snapshot cache grain for <see cref="CounterAggregate" /> instances.
/// </summary>
/// <remarks>
///     <para>
...
internal sealed class CounterAggregateSnapshotCacheGrain : SnapshotCacheGrainBase<CounterAggregate>
{
    /// <summary>
    ///     Initializes a new instance of the <see cref="CounterAggregateSnapshotCacheGrain" /> class.
    /// </summary>
    ...
    public CounterAggregateSnapshotCacheGrain(
        ...
        ILogger<CounterAggregateSnapshotCacheGrain> logger
    )
        : base(
            grainContext,
    ...
    /// <inheritdoc />
    protected override CounterAggregate CreateInitialState() =>
        new()
        {
            Count = 0,
            DecrementCount = 0,
