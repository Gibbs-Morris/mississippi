...
///         Both <see cref="CounterState" /> (the aggregate state) and this projection
///         derive from the same <see cref="CounterBrook" /> event stream, but serve
///         different purposes:
///     </para>
///     <list type="bullet">
///         <item>
///             <description>
///                 <see cref="CounterState" /> is the write-side aggregate state used for
...
[GenerateSerializer]
[Alias("Crescent.ConsoleApp.Domain.CounterSummaryProjection")]
