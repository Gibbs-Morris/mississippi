---
id: archived-legacy-home
title: Legacy Documentation Home
sidebar_label: Legacy Home
description: Preserved copy of the previous Mississippi docs home page from before the product-section reset.
sidebar_position: 99
---
...
| Maintain the docs set itself | [Documentation Guide](../docs/contributing/documentation-guide.md) | Contributing |
...
- [Documentation Guide](../docs/contributing/documentation-guide.md) - See the page-type and structure rules that govern this docs set
