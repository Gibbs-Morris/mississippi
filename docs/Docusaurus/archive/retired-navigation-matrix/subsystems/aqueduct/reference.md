...
slug: /subsystems/aqueduct/reference
---
...
For failure behavior, refer to the [Aqueduct Operations](operations.md) page and standard Orleans cluster diagnostics.
...
- Read [Aqueduct Operations](operations.md) for the current operational scope.
