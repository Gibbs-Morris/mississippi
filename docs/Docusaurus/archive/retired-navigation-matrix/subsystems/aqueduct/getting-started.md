...
slug: /subsystems/aqueduct/getting-started
---
...
2. Open [Aqueduct Reference](reference.md) and identify which of the three package boundaries matches the question you are trying to answer.
...
- Read [Aqueduct Concepts](concepts.md).
- Use [Aqueduct Reference](reference.md) for the currently verified package surface.
- Use [Aqueduct Operations](operations.md) if your next question is operational.
