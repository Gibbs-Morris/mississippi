...
slug: /subsystems/aqueduct/operations
---
...
This page covers the operational boundary for Aqueduct gateway and runtime hosting. For package-level details, see the [Aqueduct Reference](reference.md).
...
Refer to the [Aqueduct Reference](reference.md) for failure behavior at the package level. Orleans cluster diagnostics apply to any silo hosting Aqueduct components.
...
- Use [Aqueduct Reference](reference.md) for the currently verified package surface.
