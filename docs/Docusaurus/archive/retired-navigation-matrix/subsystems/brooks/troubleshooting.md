...
slug: /subsystems/brooks/troubleshooting
---
...
Use [How To Choose A Brooks Package Entry Point](how-to.md) if the issue still belongs to Brooks. Otherwise switch to the correct subsystem overview.
...
- Read [Brooks Getting Started](getting-started.md).
