...
slug: /subsystems/brooks/reference
---
...
For provider and serializer failure behavior, refer to the [Brooks Operations](operations.md) page and standard Orleans persistence diagnostics.
...
- Read [Brooks Concepts](concepts.md).
- Use [Brooks Operations](operations.md) for the current operational scope.
