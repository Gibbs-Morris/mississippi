...
slug: /subsystems/brooks/operations
---
...
This page covers the operational boundary for Brooks stream runtime, serialization seams, and provider contracts. For package-level details, see the [Brooks Reference](reference.md).
...
Refer to the [Brooks Reference](reference.md) for failure behavior at the package level. Provider-specific diagnostics follow standard Orleans persistence and stream patterns.
...
- Use [Brooks Reference](reference.md) for the currently verified package surface.
