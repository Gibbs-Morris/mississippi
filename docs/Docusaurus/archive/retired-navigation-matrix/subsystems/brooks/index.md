...
- [Brooks Getting Started](getting-started.md) - Start with the event-stream entry points
- [Brooks Concepts](concepts.md) - Understand the stream, serialization, and provider boundary
- [Brooks Reference](reference.md) - Review the currently verified package and ownership surface
- [Brooks Operations](operations.md) - See the current operational scope and open evidence gaps
