...
slug: /subsystems/domain-modeling/getting-started
---
...
2. Open [Domain Modeling Reference](reference.md) and identify the package boundary that matches the work.
...
- Read [Domain Modeling Concepts](concepts.md).
- Use [Domain Modeling Reference](reference.md) for the currently verified package surface.
