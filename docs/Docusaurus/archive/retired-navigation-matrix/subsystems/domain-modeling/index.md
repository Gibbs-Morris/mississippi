...
slug: /subsystems/domain-modeling
---
...
- [Domain Modeling Getting Started](getting-started.md) - Start with the domain-facing entry points
- [Domain Modeling Concepts](concepts.md) - Understand the aggregate, saga, and projection boundary
- [Domain Modeling Reference](reference.md) - Review the currently verified package and ownership surface
