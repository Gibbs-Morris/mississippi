...
slug: /subsystems/refraction/reference
---
...
For component-level failure behavior, refer to standard Blazor rendering diagnostics and the [Refraction Concepts](concepts.md) page.
...
- Read [Refraction Concepts](concepts.md).
- Use [Refraction Troubleshooting](troubleshooting.md) if you are still deciding whether the problem belongs here.
