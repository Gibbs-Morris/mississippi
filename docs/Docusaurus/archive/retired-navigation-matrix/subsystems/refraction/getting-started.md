...
slug: /subsystems/refraction/getting-started
---
...
2. Open [Refraction Reference](reference.md) and identify which Refraction package boundary matches the question you are trying to answer.
...
- Use [Refraction Reference](reference.md) for the currently verified package surface.
