...
- [Refraction Getting Started](getting-started.md) - Start with the UX-layer entry points
- [Refraction Concepts](concepts.md) - Understand the state-down, events-up model
- [Refraction Reference](reference.md) - Review the currently verified package and ownership surface
