...
slug: /subsystems/refraction/troubleshooting
---
...
Use [How To Decide Between Refraction And Reservoir](how-to.md) if the question is still on the client side but the boundary is unclear.
...
- Read [Refraction Getting Started](getting-started.md).
