...
slug: /subsystems/inlet/operations
---
...
This page covers the operational boundary for Inlet generator alignment across client, gateway, and runtime surfaces. For package-level details, see the [Inlet Reference](reference.md).
...
Refer to the [Inlet Reference](reference.md) for failure behavior at the package level. Generator output misalignment typically surfaces at compile time rather than runtime.
...
- Use [Inlet Reference](reference.md) for the currently verified package surface.
