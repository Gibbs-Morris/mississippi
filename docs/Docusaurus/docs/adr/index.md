...
- [Architecture Decision Records key principles (repository markdown)](https://github.com/Gibbs-Morris/mississippi/blob/main/docs/key-principles/architecture-decision-records.md) - Long-lived ADR rationale and usage guidance for the framework's ADR usage
