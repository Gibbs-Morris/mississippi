...
| **Keep hosts minimal** with source-generated registration | [Host Architecture](../../concepts/spring-host-architecture.md) |
...
- [Key Concepts](../../concepts/spring-domain-model.md) - Quick reference for the domain-modeling vocabulary used throughout Spring
- [Host Architecture](../../concepts/spring-host-architecture.md) - How Runtime, Gateway, and Client stay minimal while the domain owns business logic
...
- [Auth-Proof Mode](../../how-to/verify-spring-generated-authorization.md) - Verify generated HTTP and subscription authorization behavior locally
- [MCP in VS Code](../../how-to/test-spring-mcp-with-vscode.md) - Connect VS Code to the Spring MCP endpoint for local tool testing
