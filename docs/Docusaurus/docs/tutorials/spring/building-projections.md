...
- [Host Architecture](../../concepts/spring-host-architecture.md) - See how projections are wired into the host with one registration call
- [Key Concepts](../../concepts/spring-domain-model.md) - Revisit the concept reference
