---
title: Verify Spring Generated Authorization
sidebar_label: Verify Authorization
sidebar_position: 2
...
# Verify Spring Generated Authorization
...
- use [Host Architecture](../concepts/spring-host-architecture.md) for the broader generated-host wiring context
...
- [Host Architecture](../concepts/spring-host-architecture.md) - Spring host wiring and generated registration overview
- [Overview](../tutorials/spring/index.md) - Spring sample architecture and learning path
- [MCP in VS Code](test-spring-mcp-with-vscode.md) - Testing generated MCP tools locally
