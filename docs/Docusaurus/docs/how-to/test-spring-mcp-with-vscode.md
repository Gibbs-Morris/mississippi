...
sidebar_label: Test MCP With VS Code
sidebar_position: 3
...
- Run through [Building an Aggregate](../tutorials/spring/building-an-aggregate.md) and test generated command tools over MCP.
- Run through [Building Projections](../tutorials/spring/building-projections.md) and test projection read tools over MCP.
- Extend your local MCP prompts using the Spring tool names validated in this page.
- [Host Architecture](../concepts/spring-host-architecture.md) - Revisit how the MCP surface fits into the Spring gateway host.
- [Key Concepts](../concepts/spring-domain-model.md) - Revisit the domain-modeling vocabulary behind the generated tools.
- [Inlet Client Registration](../reference/inlet-client-registration.md) - Look up the generated host and tool registration surface.
