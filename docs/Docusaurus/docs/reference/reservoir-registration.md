---
title: Reservoir Registration
sidebar_label: Reservoir Registration
sidebar_position: 4
...
- [Refraction](package-map.md) owns the Blazor UX layer.
- [Inlet](package-map.md) owns generated full-stack alignment.

## Defaults And Constraints

This reference covers the verified subsystem boundary and the current public
registration surface. It does not claim exhaustive runtime failure semantics.
...
For the state-transition model and currently documented constraints, refer to
the [Reservoir Concepts](../concepts/reservoir-builder-model.md) page. Verify behavior not listed here
...
- Read [Reservoir Concepts](../concepts/reservoir-builder-model.md).
- Read [Inlet Client Registration](inlet-client-registration.md) for the client-sync extensions that compose on top of Reservoir.
