...
sidebar_label: Inlet Registration
sidebar_position: 3
...
- [Aqueduct](package-map.md) owns the real-time backplane.
- [Reservoir](package-map.md) owns the client-state model.
- [Domain Modeling](package-map.md) owns domain behavior.
...
For generator and runtime registration failure behavior, refer to the [Inlet Operations](package-map.md) page. Generator misalignment typically surfaces at compile time.
...
- Read [Inlet Concepts](package-map.md).
- Read [How To Compose Inlet In Mississippi Client Apps](../how-to/compose-inlet-client.md) for startup composition guidance.
- Use the [Spring Sample](../tutorials/spring/index.md) to see Inlet composition patterns in practice.
