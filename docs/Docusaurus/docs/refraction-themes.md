---
id: refraction-themes
title: Refraction Themes
sidebar_label: Refraction Themes
---
...
- **Motion as explanation**: movement preserves continuity and clarifies cause→effect; it never exists to entertain. ([source](https://www.sciencedirect.com/science/article/abs/pii/B9781558609150500159))

### Design principles

- **Instrument first, spectacle second**: dramatic aesthetics are permitted only when they increase clarity.
- **Legibility over atmosphere**: text always lands on surfaces that actively protect contrast (blur/scrim, simplified backdrops, or solidification when needed). ([source](https://www.nngroup.com/articles/glassmorphism/))
- **Multiple signifiers**: state, interactivity, and severity are communicated with shape/weight/iconography in addition to color. ([source](https://www.w3.org/WAI/WCAG21/Understanding/use-of-color.html))
- **Adaptive comfort**: the experience includes a low-motion path and a higher-contrast / lower-transparency path for users who need it. ([source](https://www.w3.org/WAI/WCAG22/Understanding/animation-from-interactions.html))
...
- **Motion temperament**: smooth and restrained; transitions preserve orientation and relationship (where it came from, where it went). Non-essential motion can be reduced/disabled. ([source](https://www.w3.org/WAI/WCAG22/Understanding/animation-from-interactions.html))
- **Surface behavior**: translucent layers intensify on focus/interaction; reading-heavy content uses "protected" surfaces that prioritize legibility over transparency. ([source](https://www.nngroup.com/articles/glassmorphism/))
...
- Not a default for reading-heavy, office-bright workflows (it may be offered, but not forced). ([source](https://www.nngroup.com/articles/dark-mode/))
- Not a "full-time glow show": glow is a signifier, not a constant aesthetic blanket.

### Success criteria

- Feels futuristic and opinionated **without sacrificing legibility** in variable backgrounds. ([source](https://www.nngroup.com/articles/glassmorphism/))
- Motion improves understanding and can be reduced for sensitivity. ([source](https://www.sciencedirect.com/science/article/abs/pii/B9781558609150500159))
...
- **Brand-fit**: identity is expressed through controlled knobs (color, type, shape, density, emphasis), not bespoke component rework. ([source](https://www.w3.org/community/design-tokens/2025/10/28/design-tokens-specification-reaches-first-stable-version/))
- **Operational confidence**: states, validation, and system feedback are explicit, actionable, and calm.

### Design principles

- **Conformity with user expectations**: interaction patterns and component behaviors prioritize convention and consistency. ([source](https://cdn.standards.iteh.ai/samples/75258/83c8cf072187487686645aad04eff40e/ISO-9241-110-2020.pdf))
- **Self-descriptive interfaces**: controls communicate what they are and what will happen—no hidden affordances. ([source](https://cdn.standards.iteh.ai/samples/75258/83c8cf072187487686645aad04eff40e/ISO-9241-110-2020.pdf))
- **Minimal, not ambiguous**: simplify without removing signifiers; clickable vs non-clickable must be obvious. ([source](https://www.nngroup.com/articles/flat-design-best-practices/))
- **Error robustness**: mistakes are recoverable; feedback is specific and constructive. ([source](https://cdn.standards.iteh.ai/samples/75258/83c8cf072187487686645aad04eff40e/ISO-9241-110-2020.pdf))
- **Accessibility by design**: contrast and non-color cues are foundational, not optional. ([source](https://www.w3.org/TR/WCAG22/))
...
- **Surface behavior**: primarily solid/opaque surfaces for consistent legibility; translucency (if any) is rare and always protected by contrast rules. ([source](https://www.nngroup.com/articles/glassmorphism/))
- **Density posture**: defaults to comfortable readability; supports compact variants for expert/data-heavy work when needed (without changing the underlying visual logic). ([source](https://cdn.standards.iteh.ai/samples/75258/83c8cf072187487686645aad04eff40e/ISO-9241-110-2020.pdf))
...
- Not a fashion statement; avoid stylings that age quickly or reduce affordance clarity. ([source](https://www.nngroup.com/articles/flat-design-best-practices/))
- Not "one-off brand skins"; customization must remain within guardrails to preserve consistency. ([source](https://www.w3.org/community/design-tokens/2025/10/28/design-tokens-specification-reaches-first-stable-version/))

### Success criteria

- Fits common enterprise brand constraints with minimal friction while staying coherent at scale. ([source](https://www.w3.org/community/design-tokens/2025/10/28/design-tokens-specification-reaches-first-stable-version/))
- Maintains predictability, consistency, and recoverability across the entire component set. ([source](https://cdn.standards.iteh.ai/samples/75258/83c8cf072187487686645aad04eff40e/ISO-9241-110-2020.pdf))
- Meets baseline accessibility expectations for contrast and non-color communication. ([source](https://www.w3.org/TR/WCAG22/))
