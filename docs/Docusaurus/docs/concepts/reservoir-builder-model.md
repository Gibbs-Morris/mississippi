...
- Exhaustive API-level documentation for every store, reducer, selector, effect,
...
- [Reservoir-Only Client Setup](../getting-started/reservoir-only-client.md)
- [Reservoir Registration](../reference/reservoir-registration.md)
- [Inlet How To](../how-to/compose-inlet-client.md) for composing Inlet on top of Reservoir builders
