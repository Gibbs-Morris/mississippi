...
The complete setup, endpoint matrix (`200`/`401`/`403`), and troubleshooting guidance are documented on [Spring Auth-Proof Mode](../how-to/verify-spring-generated-authorization.md).
...
For the generated registration surface currently used by Spring, see the
[Inlet Client Registration](../reference/inlet-client-registration.md).
...
- [Overview](../tutorials/spring/index.md) - Return to the Spring Sample App overview
- [Key Concepts](spring-domain-model.md) - Revisit the concept reference for all patterns used
- [Inlet Client Registration](../reference/inlet-client-registration.md) - Review the generated registration contracts used by the hosts
