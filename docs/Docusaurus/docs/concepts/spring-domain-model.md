---
title: Spring Domain Model
sidebar_label: Spring Domain Model
sidebar_position: 8
...
For this Spring domain-first walkthrough, focus on `EventReducer` types in `Spring.Domain`. Client-side `ActionReducer` types are part of UI state management in the client host, not domain business logic. See [Host Applications](spring-host-architecture.md) for where client state wiring lives.
...
- [Building an Aggregate](../tutorials/spring/building-an-aggregate.md) - See these concepts in action with the BankAccount example
- [Building a Saga](../tutorials/spring/building-a-saga.md) - Orchestrate a multi-aggregate workflow
- [Building Projections](../tutorials/spring/building-projections.md) - Create read-optimized views
