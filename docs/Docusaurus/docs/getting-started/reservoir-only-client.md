---
title: Reservoir-Only Client Setup
sidebar_label: Reservoir Only
sidebar_position: 2
description: Configure Reservoir client state without the full Mississippi client and Inlet synchronization stack.
---

# Reservoir-Only Client Setup
...
- Read the [Reservoir overview](../reference/package-map.md).
- Read [Refraction](../reference/package-map.md) if the UI layer boundary is still unclear.
...
- Read [Reservoir Concepts](../concepts/reservoir-builder-model.md) for the top-level builder and feature-builder mental model.
- Read [Reservoir Registration](../reference/reservoir-registration.md) for the exact public registration surface.
- Use [Mississippi Client Setup](mississippi-client.md) if the next step is a full Mississippi client app with client sync on top of Reservoir.
