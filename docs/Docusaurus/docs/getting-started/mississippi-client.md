---
title: Mississippi Client Setup
sidebar_label: Mississippi Client
sidebar_position: 1
description: Configure a Mississippi client through AddMississippiClient, generated domain registration, Reservoir features, and optional Inlet SignalR support.
---

# Mississippi Client Setup
...
Move to [Reservoir](../reference/package-map.md) when the issue is only about client-state composition and not about projection delivery or generated cross-layer alignment.
...
- Read [Inlet How To](../how-to/compose-inlet-client.md) for a full builder-composition walkthrough.
- Use [Inlet Client Registration](../reference/inlet-client-registration.md) for the exact public and generated registration surface.
- Continue into the [Spring Sample](../tutorials/spring/index.md) for a verified end-to-end client example.
