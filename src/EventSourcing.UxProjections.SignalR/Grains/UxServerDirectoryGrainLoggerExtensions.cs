...
/// <summary>
///     Logger extensions for <see cref="UxServerDirectoryGrain" />.
/// </summary>
internal static partial class UxServerDirectoryGrainLoggerExtensions
{
    [LoggerMessage(
        EventId = 1,
    ...
    [LoggerMessage(
        EventId = 2,
        Level = LogLevel.Debug,
        Message = "Registering server '{ServerId}'")]
    ...
    [LoggerMessage(
        ...
        Message = "Heartbeat from unknown server '{ServerId}'")]
    ...
    [LoggerMessage(
        EventId = 6,
        Level = LogLevel.Debug,
        Message = "Unregistering server '{ServerId}'")]
    ...
    [LoggerMessage(
        EventId = 8,
        Level = LogLevel.Debug,
        Message = "Server '{ServerId}' not found in directory")]
