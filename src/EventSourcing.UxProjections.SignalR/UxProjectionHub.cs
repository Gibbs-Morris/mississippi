...
public sealed class UxProjectionHub : Hub<IUxProjectionHubClient>
{
    ...
    )
    {
        ...
        UxProjectionNotificationKey notificationKey = new(projectionType, new(brookType, entityId));
        IUxProjectionNotificationGrain notificationGrain =
            GrainFactory.GetGrain<IUxProjectionNotificationGrain>(notificationKey.ToString());
