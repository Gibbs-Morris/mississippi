...
";
    ...
    // NOTE: GenerateProjectionController has been moved to
    // Mississippi.EventSourcing.UxProjections.Api.Generators.ProjectionApiGenerator.
    // Projection controllers are now generated using [GenerateProjectionApi] attribute.
...
";
    ...
    )
    {
        ...
        // NOTE: Projection controllers are now generated by
        // Mississippi.EventSourcing.UxProjections.Api.Generators using [GenerateProjectionApi].
        // This generator only produces: aggregate controllers, route registry, and ripple registrations.
