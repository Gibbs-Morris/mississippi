...
internal static partial class UxProjectionSubscriptionGrainLoggerExtensions
{
    ...
    [LoggerMessage(
        ...
        Level = LogLevel.Information,
        Message =
            "Connection '{ConnectionId}' subscribed to projection with subscription ID '{SubscriptionId}' for '{ProjectionKey}'")]
    ...
    [LoggerMessage(
        ...
        Level = LogLevel.Debug,
        Message =
            "Connection '{ConnectionId}' subscribing to projection with subscription ID '{SubscriptionId}' for '{ProjectionKey}'")]
    ...
    [LoggerMessage(
        ...
        Level = LogLevel.Information,
        Message =
            "Connection '{ConnectionId}' unsubscribed from projection with subscription ID '{SubscriptionId}' for '{ProjectionKey}'")]
    ...
    [LoggerMessage(
        ...
        Level = LogLevel.Debug,
        Message =
            "Connection '{ConnectionId}' unsubscribing from projection with subscription ID '{SubscriptionId}' for '{ProjectionKey}'")]
