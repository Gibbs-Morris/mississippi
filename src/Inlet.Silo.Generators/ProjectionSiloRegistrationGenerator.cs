...
public sealed class ProjectionSiloRegistrationGenerator : IIncrementalGenerator
{
    ...
    )
    {
        ...
        sb.OpenBrace();
        sb.AppendSummary(
            $"Adds the {projection.Model.ProjectionName} projection services to the Mississippi silo builder.");
        ...
        sb.AppendLine($"public static IMississippiSiloBuilder Add{projection.Model.ProjectionName}Projection(");
        sb.IncreaseIndent();
        ...
        sb.AppendLine("builder.AddUxProjections();");
        sb.AppendLine();
        ...
        {
            sb.AppendLine(
                $"builder.AddReducer<{reducer.EventTypeName}, {projection.Model.TypeName}, {reducer.TypeName}>();");
        }
        ...
        sb.AppendLine($"builder.AddSnapshotStateConverter<{projection.Model.TypeName}>();");
