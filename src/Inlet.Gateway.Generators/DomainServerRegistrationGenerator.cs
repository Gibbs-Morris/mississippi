...
public sealed class DomainServerRegistrationGenerator : IIncrementalGenerator
{
    ...
    private static string GenerateGatewayRegistrationsSource(
    ...
    )
    {
        ...
        sb.AppendLine("using Mississippi.Hosting.Gateway;");
        sb.AppendLine();
        ...
        foreach (DomainRegistrationModel model in models.OrderBy(m => m.DomainMethodName, StringComparer.Ordinal))
        {
            ...
            sb.AppendLine("    /// <returns>The Mississippi gateway builder for chaining.</returns>");
            sb.AppendLine(
    ...
    )
    {
        ...
        foreach (DomainRegistrationModel model in models.OrderBy(m => m.DomainMethodName, StringComparer.Ordinal))
        {
            ...
            sb.AppendLine(
                $"    public static IServiceCollection {model.DomainMethodName}Server(this IServiceCollection services)");
            sb.AppendLine("    {");
    ...
    )
    {
        ...
        context.RegisterSourceOutput(
            ...
            ) =>
            {
                ...
                string gatewaySource = GenerateGatewayRegistrationsSource(result.Domains, result.TargetRootNamespace);
                spc.AddSource("DomainGatewayRegistrations.g.cs", SourceText.From(gatewaySource, Encoding.UTF8));
            });
    }
