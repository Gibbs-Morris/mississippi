...
public interface IEventReducer<TProjection>
{
    /// <summary>
    ...
    /// <returns>
    ///     A value indicating whether the event reducer can handle the supplied event and produced a projection.
    /// </returns>
    bool TryReduce(
        TProjection state,
        object eventData,
...
/// <summary>
///     Defines an event reducer that transforms an incoming event into a projection.
/// </summary>
/// <typeparam name="TEvent">The event type consumed by the event reducer.</typeparam>
/// <typeparam name="TProjection">The projection type produced by the event reducer.</typeparam>
public interface IEventReducer<in TEvent, TProjection> : IEventReducer<TProjection>
{
    /// <summary>
