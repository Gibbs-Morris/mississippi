...
public static class AqueductGrainsRegistrations
{
    ...
    ///         For configuration examples, refer to the sample projects in the repository
    ///         under samples/ that demonstrate Aqueduct setup for various scenarios including
    ///         basic configuration, development/testing with in-memory streams, and production
    ///         with custom stream providers.
    ///     </para>
    /// </remarks>
