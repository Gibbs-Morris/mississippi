...
public static class AqueductGrainsRegistrations
{
    ...
    ///         Use the <see cref="AqueductSiloOptions" /> to configure stream providers by setting
    ///         the StreamProviderName property or calling UseMemoryStreams for development scenarios.
    ///         See sample Runtime projects for configuration patterns.
    ///     </para>
    /// </remarks>
