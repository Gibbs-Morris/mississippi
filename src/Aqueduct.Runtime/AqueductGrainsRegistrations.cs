...
public static class AqueductGrainsRegistrations
{
    ...
    ///     </para>
    ///     <para>
    ///         For basic setup, specify the stream provider name in options. For development and testing,
    ///         use <c>UseMemoryStreams()</c> on the options. For production deployments with custom
    ///         stream configuration, use <c>UseMemoryStreams</c> with explicit provider and store names.
    ///     </para>
    ///     <para>
