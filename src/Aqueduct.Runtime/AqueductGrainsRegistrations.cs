...
public static class AqueductGrainsRegistrations
{
    ...
    ///         For basic setup, specify the StreamProviderName in the options delegate.
    ///         For development and testing, the options provide a UseMemoryStreams helper method
    ///         with optional provider and storage names.
    ///     </para>
    /// </remarks>
