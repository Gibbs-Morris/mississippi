...
/// <summary>
///     Renders a presentational action bar that groups enterprise command triggers.
/// </summary>
public sealed partial class ActionBar : ComponentBase
{
    /// <summary>
    ...
    private string RootCssClass =>
        string.IsNullOrWhiteSpace(AdditionalCssClass) ? "rf-action-bar" : $"rf-action-bar {AdditionalCssClass}";
