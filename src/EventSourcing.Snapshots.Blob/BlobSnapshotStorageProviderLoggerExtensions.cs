...
/// <summary>
///     High-performance logging extensions for <see cref="BlobSnapshotStorageProvider" />.
/// </summary>
internal static partial class BlobSnapshotStorageProviderLoggerExtensions
{
    /// <summary>
    ...
    [LoggerMessage(
        ...
        Message = "Deleting all snapshots for stream '{StreamKey}' from blob storage")]
    ...
    [LoggerMessage(
        ...
        Message = "Deleting snapshot '{SnapshotKey}' from blob storage")]
    ...
    /// <param name="logger">The logger instance.</param>
    /// <param name="snapshotKey">The snapshot key.</param>
    [LoggerMessage(EventId = 1, Level = LogLevel.Debug, Message = "Reading snapshot '{SnapshotKey}' from blob storage")]
    ...
    /// <param name="logger">The logger instance.</param>
    /// <param name="snapshotKey">The snapshot key.</param>
    [LoggerMessage(EventId = 4, Level = LogLevel.Debug, Message = "Writing snapshot '{SnapshotKey}' to blob storage")]
