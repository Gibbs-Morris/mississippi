...
internal static partial class InProcessProjectionUpdateNotifierLoggerExtensions
{
    [LoggerMessage(
        ...
        Message = "Subscription created for {ProjectionType} entity {EntityId}")]
    ...
    [LoggerMessage(
        Level = LogLevel.Debug,
        Message = "Subscription removed for {ProjectionType} entity {EntityId}")]
    ...
    [LoggerMessage(
        Level = LogLevel.Debug,
        Message = "Notifying {SubscriberCount} subscribers for {ProjectionType} entity {EntityId} at version {NewVersion}")]
    ...
    [LoggerMessage(
        ...
        Message = "Callback failed for {ProjectionType} entity {EntityId}")]
