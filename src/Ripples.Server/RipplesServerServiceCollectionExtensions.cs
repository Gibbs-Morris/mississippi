...
public static class RipplesServerServiceCollectionExtensions
{
    ...
    /// </para>
    /// </remarks>
    public static IServiceCollection AddRipplesServer(this IServiceCollection services)
    {
    ...
    /// <param name="services">The service collection.</param>
    /// <returns>The service collection for chaining.</returns>
    public static IServiceCollection AddServerRipple<TProjection>(this IServiceCollection services)
