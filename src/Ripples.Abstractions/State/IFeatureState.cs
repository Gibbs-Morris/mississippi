...
/// <summary>
///     Marker interface for feature state slices in the Ripples state tree.
/// </summary>
/// <remarks>
///     <para>
///         Feature states are registered with the store and identified by a unique key.
///         Each feature state represents a slice of the application state (UI, forms, session, projections).
///     </para>
///     <para>
