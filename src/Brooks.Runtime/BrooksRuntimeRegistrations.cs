...
public static class BrooksRuntimeRegistrations
{
    ...
    ///         is responsible for that. Use <paramref name="configureOptions" /> to specify
    ///         which stream provider Brooks should use by setting <c>OrleansStreamProviderName</c>.
    ///         The host must configure streams and storage separately.
    ///         Refer to sample applications for concrete configuration patterns.
    ///     </para>
    /// </remarks>
