...
internal static partial class ClientRipplePoolLoggerExtensions
{
    ...
    [LoggerMessage(Level = LogLevel.Trace, Message = "GetOrCreate {ProjectionType} entity {EntityId}")]
    ...
    [LoggerMessage(Level = LogLevel.Trace, Message = "Marked {ProjectionType} entity {EntityId} as hidden (warm)")]
    ...
    [LoggerMessage(Level = LogLevel.Trace, Message = "Marked {ProjectionType} entity {EntityId} as visible (hot)")]
    ...
    [LoggerMessage(Level = LogLevel.Debug, Message = "Prefetching {Count} {ProjectionType} projections")]
