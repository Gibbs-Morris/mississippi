...
internal static partial class ClientRippleLoggerExtensions
{
    ...
    [LoggerMessage(Level = LogLevel.Debug, Message = "Refreshed {ProjectionType} entity {EntityId}")]
    ...
    [LoggerMessage(Level = LogLevel.Debug, Message = "Subscribed to {ProjectionType} entity {EntityId}")]
    ...
    [LoggerMessage(Level = LogLevel.Error, Message = "Subscription to {ProjectionType} entity {EntityId} failed")]
    ...
    [LoggerMessage(Level = LogLevel.Debug, Message = "Unsubscribed from {ProjectionType} entity {EntityId}")]
