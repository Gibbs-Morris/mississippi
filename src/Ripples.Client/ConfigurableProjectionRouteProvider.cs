...
public sealed class ConfigurableProjectionRouteProvider : IProjectionRouteProvider
{
    ...
    /// <inheritdoc />
    public string GetRoute<TProjection>() => GetRoute(typeof(TProjection));
    ...
    public ConfigurableProjectionRouteProvider Register<TProjection>(
        string route
    )
    {
    ...
    /// <param name="route">The API route path.</param>
    /// <returns>This instance for method chaining.</returns>
    public ConfigurableProjectionRouteProvider Register(
        Type projectionType,
        string route
    )
    {
    ...
    /// <inheritdoc />
    public bool TryGetRoute<TProjection>(
        out string? route
    ) =>
