...
public static class RipplesClientServiceCollectionExtensions
{
    ...
    public static IServiceCollection AddClientRipple<TProjection>(
    ...
    /// <param name="services">The service collection.</param>
    /// <returns>The service collection for method chaining.</returns>
    public static IServiceCollection AddClientRipplePool<TProjection>(
        this IServiceCollection services
    )
        where TProjection : class
    {
    ...
    )
    {
        ...
        services.TryAddSingleton<IProjectionRouteProvider>(new ConfigurableProjectionRouteProvider());
        return services;
    }
