...
/// <summary>
///     Extension methods for registering Ripples Orleans services.
/// </summary>
/// <remarks>
///     <para>
///         Use these extensions on Orleans silo hosts. For ASP.NET Core hosts
///         that serve SignalR hubs, use the extensions from <c>Ripples.Orleans.SignalR</c>.
///     </para>
/// </remarks>
public static class RipplesOrleansServiceCollectionExtensions
{
    /// <summary>
    ///     Adds Ripples Orleans services to the service collection.
    /// </summary>
    ...
    ///     </para>
    /// </remarks>
    public static IServiceCollection AddRipplesOrleans(
    ...
    ///     </para>
    ///     <para>
    ///         Call this after <see cref="AddRipplesOrleans" /> to populate the registry.
    ///     </para>
    /// </remarks>
    ...
    )
    {
        ...
        // Build the registry during configuration
        ...
        foreach (Assembly assembly in assemblies)
        {
            foreach (Type type in assembly.GetExportedTypes())
            {
                ...
                // Use BrookName from attribute, or fall back to type name
        ...
        // Replace the registration with the populated registry
