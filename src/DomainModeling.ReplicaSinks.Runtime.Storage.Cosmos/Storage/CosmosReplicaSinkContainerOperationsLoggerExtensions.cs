...
internal static partial class CosmosReplicaSinkContainerOperationsLoggerExtensions
{
    [LoggerMessage(
        ...
        Message = "Ensuring Cosmos replica sink '{SinkKey}' container '{DatabaseId}/{ContainerId}' with provisioning mode '{ProvisioningMode}'.")]
    ...
    [LoggerMessage(
        ...
        Message = "Cosmos replica sink '{SinkKey}' container '{DatabaseId}/{ContainerId}' is missing for provisioning mode '{ProvisioningMode}'.")]
    ...
    [LoggerMessage(
        EventId = 4408,
        Level = LogLevel.Debug,
        Message = "Inspected Cosmos replica sink '{SinkKey}' target '{TargetName}' (Exists: {TargetExists}, WriteCount: {WriteCount}).")]
    ...
    [LoggerMessage(
        EventId = 4411,
        Level = LogLevel.Debug,
        Message = "Writing Cosmos replica sink '{SinkKey}' delivery '{DeliveryKey}' for target '{TargetName}' at source position {SourcePosition}.")]
    ...
    [LoggerMessage(
        EventId = 4412,
        Level = LogLevel.Debug,
        Message = "Wrote Cosmos replica sink '{SinkKey}' delivery '{DeliveryKey}' for target '{TargetName}' at source position {SourcePosition}.")]
