...
/// <example>
///     <code>
/// public sealed class DepositFundsEffect : ActionEffectBase&lt;DepositFundsAction, BankAccountState&gt;
/// {
...
///     {
///         // Perform async work
///         yield return new DepositCompletedAction(action.AccountId, action.Amount);
///     }
/// }
///     </code>
/// </example>
