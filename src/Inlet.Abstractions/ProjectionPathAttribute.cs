...
///     </para>
///     <para>
///         Apply this attribute to both server-side projection classes (in the Domain project)
///         and client-side DTO classes (in the Client project, WASM-safe) using the same path value.
///     </para>
/// </remarks>
