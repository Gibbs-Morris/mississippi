...
///     </para>
///     <para>
///         Apply this attribute to both server-side projection classes and client-side DTOs
///         using the same path. See projection implementations in sample applications for usage patterns.
///     </para>
/// </remarks>
