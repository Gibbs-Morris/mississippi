...
///     </para>
///     <para>
///         Apply this attribute to both server-side projection records (in Domain project)
///         and client-side DTO records (in Contracts project) with matching path values.
///         The path format should be {feature}/{module} (e.g., "chat/channels").
///     </para>
/// </remarks>
