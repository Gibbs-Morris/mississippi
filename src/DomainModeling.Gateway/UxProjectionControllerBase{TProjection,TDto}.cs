...
///         the internal projection representation from the public API contract. Derived classes
///         should apply a route attribute and inject the required factory, mapper, and logger
///         dependencies.
///     </para>
///     <para>
