...
///     </para>
///     <para>
///         Derive from this class and apply a route attribute to create a projection endpoint controller.
///         The controller automatically maps between the projection and DTO types.
