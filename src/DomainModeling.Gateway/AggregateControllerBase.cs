...
///         The derived class must apply a route attribute (e.g., [Route("api/users/{entityId}")])
///         and can customize behavior or add additional endpoints. Use the ExecuteAsync helper
///         to wire HTTP POST endpoints to aggregate command handlers.
///     </para>
///     <para>
