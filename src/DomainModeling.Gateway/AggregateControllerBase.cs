...
///         The derived class must apply a route attribute (for example, [Route("api/users/{entityId}")])
///         and can customize behavior or add additional endpoints. Typical usage involves injecting
///         a service and calling ExecuteAsync from HTTP action methods.
///     </para>
///     <para>
