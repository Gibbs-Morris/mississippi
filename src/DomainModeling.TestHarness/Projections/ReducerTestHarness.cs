...
///         Call Apply to execute the reducer or use ShouldProduce for expected output assertions.
///     </para>
///     <para>
...
///         Create a harness with ForProjection, add reducers with WithReducer, then run scenarios
///         using Given/When/Then. See test examples in the repository for usage patterns.
///     </para>
/// </remarks>
