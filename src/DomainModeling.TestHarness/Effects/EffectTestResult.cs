...
///     </para>
///     <para>
///         This class is public to support extensibility in external test projects
///         that reference the test harness package and need domain-specific assertion methods.
///     </para>
/// </remarks>
