...
///     </list>
///     <para>
///         Usage: Call ForAggregate on CommandHandlerTestExtensions, register handlers and reducers
///         via WithHandler and WithReducer, then CreateScenario to build test scenarios with Given/When/Then.
///     </para>
///     <para>
