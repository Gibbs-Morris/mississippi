...
///     </para>
///     <para>
///         See the test projects in the repository for concrete usage examples following
///         the Given/When/Then pattern with command handlers, reducers, and assertions.
///     </para>
/// </remarks>
