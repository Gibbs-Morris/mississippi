    ...
    )
    {
        ...
        projectionDtos.Select(dto => dto.TypeName)
            ...
            .ForEach(typeName =>
            {
                ...
                sb.AppendLine(
                    $"            feature.AddReducer<ProjectionLoadingAction<{typeName}>>(ProjectionsReducer.ReduceLoading<{typeName}>);");
                sb.AppendLine(
                    $"            feature.AddReducer<ProjectionLoadedAction<{typeName}>>(ProjectionsReducer.ReduceLoaded<{typeName}>);");
                sb.AppendLine(
                    $"            feature.AddReducer<ProjectionUpdatedAction<{typeName}>>(ProjectionsReducer.ReduceUpdated<{typeName}>);");
                sb.AppendLine(
                    $"            feature.AddReducer<ProjectionErrorAction<{typeName}>>(ProjectionsReducer.ReduceError<{typeName}>);");
                sb.AppendLine(
                    $"            feature.AddReducer<ProjectionConnectionChangedAction<{typeName}>>(ProjectionsReducer.ReduceConnectionChanged<{typeName}>);");
                sb.AppendLine();
            });
        sb.AppendLine("        });");
