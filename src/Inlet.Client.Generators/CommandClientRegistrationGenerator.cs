...
public sealed class CommandClientRegistrationGenerator : IIncrementalGenerator
{
    ...
    )
    {
        ...
        foreach (string commandName in aggregate.CommandNames.OrderBy(n => n))
        {
            ...
            sb.AppendLine($"featureBuilder.AddReducer<{commandName}ExecutingAction>(");
            sb.IncreaseIndent();
            sb.AppendLine($"{reducersTypeName}.{commandName}Executing);");
            sb.DecreaseIndent();
            sb.AppendLine($"featureBuilder.AddReducer<{commandName}SucceededAction>(");
            sb.IncreaseIndent();
            sb.AppendLine($"{reducersTypeName}.{commandName}Succeeded);");
            sb.DecreaseIndent();
            sb.AppendLine($"featureBuilder.AddReducer<{commandName}FailedAction>(");
            sb.IncreaseIndent();
        ...
        foreach (string commandName in aggregate.CommandNames.OrderBy(n => n))
        {
            sb.AppendLine($"featureBuilder.AddActionEffect<{commandName}ActionEffect>();");
        }
