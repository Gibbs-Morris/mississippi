...
{
    private static void AppendLifecycleReducers(
        SourceBuilder sb,
    ...
    )
    {
        ...
        sb.AppendLine(") =>");
        sb.IncreaseIndent();
        sb.AppendLine("AggregateCommandStateReducers.ReduceCommandExecuting(state, action) with");
        sb.AppendLine("{");
        sb.IncreaseIndent();
        sb.AppendLine("LastResumeResponse = null,");
        sb.DecreaseIndent();
        sb.AppendLine("};");
        sb.DecreaseIndent();
        sb.AppendLine();
        ...
        sb.AppendLine(") =>");
        sb.IncreaseIndent();
        sb.AppendLine("AggregateCommandStateReducers.ReduceCommandFailed(state, action) with");
        sb.AppendLine("{");
        sb.IncreaseIndent();
        sb.AppendLine("LastResumeResponse = null,");
        sb.DecreaseIndent();
        ...
        sb.AppendLine(") =>");
        sb.IncreaseIndent();
        sb.AppendLine("AggregateCommandStateReducers.ReduceCommandSucceeded(state, action) with");
        sb.AppendLine("{");
        sb.IncreaseIndent();
        sb.AppendLine($"LastResumeResponse = {successExpression},");
        sb.DecreaseIndent();
        sb.AppendLine("};");
        sb.DecreaseIndent();
    }
    ...
    )
    {
        ...
        sb.AppendLine("///     <para>");
        sb.AppendLine(
            "///         Each saga start or manual resume request has lifecycle reducers (Executing, Failed, Succeeded) that delegate");
        ...
        sb.OpenBrace();
        AppendLifecycleReducers(sb, stateTypeName, $"Start{saga.SagaName}Saga", "null");
        sb.AppendLine();
        AppendLifecycleReducers(sb, stateTypeName, $"Resume{saga.SagaName}Saga", "action.Response");
        sb.CloseBrace();
