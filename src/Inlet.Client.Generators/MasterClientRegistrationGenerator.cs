...
///         for generated registration classes (e.g., BankAccountAggregateFeatureRegistration)
...
public sealed class MasterClientRegistrationGenerator : IIncrementalGenerator
{
    ...
    )
    {
        ...
        {
            // Look for static classes ending in "Registration" (singular)
            if (!typeSymbol.IsStatic || !typeSymbol.Name.EndsWith("Registration", StringComparison.Ordinal))
            {
                continue;
            }
