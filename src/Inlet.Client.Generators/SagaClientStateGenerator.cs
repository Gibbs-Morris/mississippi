...
public sealed class SagaClientStateGenerator : IIncrementalGenerator
{
    ...
    )
    {
        ...
        sb.AppendLine();
        sb.AppendSummary($"Feature state for {saga.SagaName} saga start and manual resume execution.");
        sb.AppendLine("/// <remarks>");
        sb.AppendLine("///     <para>");
        sb.AppendLine(
            "///         This state tracks saga start and manual resume requests via command-style lifecycle tracking.");
        sb.AppendLine("///     </para>");
        sb.AppendLine("/// </remarks>");
        ...
        sb.AppendLine("///     Gets the most recent typed manual resume response, if any.");
        sb.AppendLine("/// </summary>");
        sb.AppendLine("public SagaResumeResponse? LastResumeResponse { get; init; }");
        sb.CloseBrace();
