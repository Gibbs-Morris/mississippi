...
internal class EventBrookReader : IEventBrookReader
{
    ...
    public EventBrookReader(ICosmosRepository repository, IRetryPolicy retryPolicy, IOptions<BrookStorageOptions> options, IMapper<EventStorageModel, BrookEvent> eventMapper)
    {
