...
/// <summary>
/// Provides low-level Cosmos DB operations for event stream management.
/// </summary>
internal interface ICosmosRepository
{
    /// <summary>
    /// Gets the head document for the specified brook stream.
    /// </summary>
    ...
    /// <summary>
    /// Gets the pending head document for the specified brook stream.
    /// </summary>
    /// <param name="brookId">The brook identifier specifying the target stream.</param>
    /// <param name="cancellationToken">A cancellation token to cancel the operation.</param>
    ...
    /// <summary>
    /// Checks if an event exists at the specified position in the brook stream.
    /// </summary>
    /// <param name="brookId">The brook identifier specifying the target stream.</param>
    ...
    /// <summary>
    /// Deletes an event at the specified position from the brook stream.
    /// </summary>
    /// <param name="brookId">The brook identifier specifying the target stream.</param>
    ...
    /// <summary>
    /// Deletes the pending head document for the specified brook stream.
    /// </summary>
    /// <param name="brookId">The brook identifier specifying the target stream.</param>
    /// <param name="cancellationToken">A cancellation token to cancel the operation.</param>
    /// <returns>A task representing the asynchronous operation.</returns>
    ...
    /// <summary>
    /// Appends a batch of events to the brook stream starting at the specified position.
    /// </summary>
    /// <param name="brookId">The brook identifier specifying the target stream.</param>
