...
internal static partial class SnapshotBlobStartupLoggerExtensions
{
    ...
    [LoggerMessage(
        ...
        Level = LogLevel.Error,
        Message =
            "Blob snapshot startup validation failed for container '{containerName}' because payload serializer format '{payloadSerializerFormat}' could not be resolved.")]
    ...
    public static partial void CreatingBlobContainer(
        this ILogger<BlobContainerInitializer> logger,
        string containerName
    );
    ...
    [LoggerMessage(
        ...
        Level = LogLevel.Information,
        Message =
            "Validated snapshot payload serializer format '{configuredFormat}' using provider '{resolvedFormat}'.")]
